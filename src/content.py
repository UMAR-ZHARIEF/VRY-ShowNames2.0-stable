...
class Content():
    ...
    def get_all_agents(self):
        rAgents = static_content.get_json("/v1/agents?isPlayableCharacter=true")
        if rAgents is None:
            raise ConnectionError("valorant-api.com /v1/agents unavailable")
        agent_dict = {}
    ...
    def get_all_maps(self):
        ...
        """
        maps = static_content.get_json("/v1/maps")
        if maps is None:
            raise ConnectionError("valorant-api.com /v1/maps unavailable")
        return maps
